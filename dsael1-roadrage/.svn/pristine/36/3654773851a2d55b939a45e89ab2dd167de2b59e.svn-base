...
public final class FileLoader {
     ...
     */
    public static RoadRagePanel readCity(final JFrame theFrame) {
        RoadRagePanel result = null;
        try {
            final Scanner input;
            ...
            result = new RoadRagePanel(readGrid(input), readVehicles(input));        
