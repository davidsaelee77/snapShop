...
public class SnapShopGUI extends JFrame {
    ...
    /**
     * {@code} Helper method to disables all buttons, clears image from container,
     * removes size modifications and sets window back to default.
     * 
    ...
    /**
     * {@code} Helper method to display JOptionPane message when
    ...
    /**
     * {@code} Helper method used to save image after manipulation.  Displays
    ...
    /**
     * {@code} Helper method used to open image.  Displays
     * message if invalid entries are inputed.  Loops through
     * code until valid entry is chosen. 
     * 
     * @param theChooser value passed in as argument.
    ...
    /**
     * {@code} Helper method used to close image.  Will
    ...
    /**
     * {@code} Method to display JOption dialog.
     * 
     * @param theLabel value passed in as argument.
